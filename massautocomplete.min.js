...
1?a.selected_index-1:a.results.length-1),a.$apply())}})}var l=this,m={TAB:9,ESC:27,ENTER:13,UP:38,DOWN:40},g={KEYDOWN:"keydown",RESIZE:"resize",BLUR:"blur"},q=a.options()||{},p={debounce_position:q.debounce_position||150,debounce_attach:q.debounce_attach||300,debounce_suggest:q.debounce_suggest||200,debounce_blur:q.debounce_blur||150},d,h,c,u,v,y;a.show_autocomplete=!1;var A=s(w,p.debounce_position);l.attach=s(function(b,k,e){d!==k&&(d&&l.detach(),k[0]===f[0].activeElement&&(e.on_attach&&e.on_attach(),
d=k,h=b,c=e,u=b.$viewValue,a.results=[],a.selected_index=-1,z(),v=a.$watch(function(){return b.$modelValue},function(b,c){b!==y&&(a.results&&(a.results.length=0),w(),B(b))})))},p.debounce_attach);var B=s(function(b){a.selected_index=0;a.show_autocomplete=!1;a.waiting_for_suggestion=!0;"string"===typeof b&&0<b.length?n.when(c.suggest(b),function(c){c&&0<c.length?(a.results=[{value:b,label:""}].concat(c),a.show_autocomplete=!0):a.results=[]},function(a){c.on_error&&c.on_error(a)})["finally"](function(){a.waiting_for_suggestion=
!1}):(a.waiting_for_suggestion=!1,a.$apply())},p.debounce_suggest);l.detach=function(){if(d){var b=d.val();x(b);c.on_detach&&c.on_detach(b);d.unbind(g.KEYDOWN);d.unbind(g.BLUR)}a.show_autocomplete=!1;angular.element(e).unbind(g.RESIZE);v&&v();h=d=u=a.selected_index=a.results=void 0};a.apply_selection=function(b){d[0].focus();!a.show_autocomplete||b>a.results.length||0>b||(b=t(b),y=b.value,x(b.value),a.show_autocomplete=!1,c.on_select&&c.on_select(b))};a.$on("$destroy",function(){l.detach();a.container.remove()})}]}}]).directive("massAutocompleteItem",
function(){return{restrict:"A",require:["^massAutocomplete","ngModel"],scope:!1,link:function(r,e,f,n){f.$set("autocomplete","off");e.bind("focus",function(){var a=r[f.massAutocompleteItem];if(!a)throw"Invalid options";n[0].attach(n[1],e,a)})}}});